...
{
   RegisterDevice(g_WheelDeviceName, MM::StateDevice, "Thorlabs MFF");
}
   ...
   port_("")
{
   ...
   //Com port
   CPropertyAction* pAct = new CPropertyAction (this, &ThorlabsMFF::OnCOMPort);
...
int ThorlabsMFF::Initialize()
{
   ...
   // Description
   ret = CreateProperty(MM::g_Keyword_Description, "Thorlabs MFF driver", MM::String, true);
   if (DEVICE_OK != ret)
      return ret;
   ...
   // State
   // -----
   CPropertyAction* pAct = new CPropertyAction (this, &ThorlabsMFF::OnState);
...
int ThorlabsMFF::OnState(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
      printf("Getting position of filter flipper device\n");
      pProp->Set(position_);
...
int ThorlabsMFF::OnCOMPort(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
...
void ThorlabsMFF::InitializeMFF()
{   
