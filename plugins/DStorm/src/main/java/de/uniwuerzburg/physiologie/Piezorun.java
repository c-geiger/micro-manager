...
//	}
//	
//?public void setPiezoConfigurationOfTriggerInputType (boolean trigger){
//		
//		if (trigger){mmc.setSerialPortCommand("Port", "TRI 1 1" , "\n"); }
//		else{
//			mmc.setSerialPortCommand(port, "TRI? 1" , "\n");
...
//}
//
//?public void setPiezoConfigurationOfTriggerInputPolarity (boolean trigger){
//	
//	if (trigger){mmc.setSerialPortCommand("Port", "TRI 1 1" , "\n"); }
//	else{
//		mmc.setSerialPortCommand(port, "TRI? 1" , "\n");
...
//	setPiezoTriggerOutput(); 			//Set Configuration of trigger output Triggerinputchannel 2 triggermode(1) to trigger line action defined with TWS(4) (associates trigger output with waveform
//	
...
//}
//
//	public void setPiezoTriggerOutput()  {
//		mmc.setSerialPortCommand(port, "CTO 1 3 4" , "\n");
//		mmc.setSerialPortCommand(port, "TWC" , "\n");
//		mmc.setSerialPortCommand(port, "TWS 1 1 1" , "\n");
//		mmc.setSerialPortCommand(port, "TWS 1 5 1" , "\n");
//		mmc.setSerialPortCommand(port, "TWS 1 10 1" , "\n");
//		mmc.setSerialPortCommand(port, "TWS 1 15 1" , "\n");
//	} 
//
//int i = 1;
//
