...
//			accSettings.metadataPath = this.acqDirPath + File.separator + "Scan_" + this.imgDirName+ File.separator + this.imgDirName + ".ass"  ;
			...
			accSettings.filenamearrayPath = this.acqDirPath + File.separator + File.separator + this.imgDirName + "ch1.bji"  ;
		...
		if ( this.channel == "channel2" && !accSettings.calOnly){
			...
			accSettings.filenamearrayPath = this.acqDirPath + File.separator + File.separator + this.imgDirName + "ch2.bji"  ;
